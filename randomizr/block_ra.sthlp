...
{pstd} {inp:. block_ra, blocks(block) }{p_end}
{pstd} {inp:. block_ra, blocks(block) prob(.3) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_prob(.1 .2 .3) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) m(20) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_m(20 30 40) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_m_each(25, 25\50,50\100,100) replace }{p_end}
{pstd} {inp:. matrix define block_m_each=(10, 40\30,70\50,150) }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_m_each(block_m_each) replace conditions(control treatment) }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_m_each(10, 20, 20\30,50,20\50,75,75) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) block_m_each(10, 20, 20\30,50,20\50,75,75) conditions(control placebo treatment) replace }{p_end}
{pstd} {inp:. block_ra, blocks(block) prob_each(.1 .1 .8) replace }{p_end}
